...
resource "aws_iam_role_policy_attachment" "the_patient_creation_validator_lambda_execution_role_policy_attachment" {
  policy_arn = aws_iam_policy.the_patient_creation_validator_lambda-execution_policy.arn
  role       = aws_iam_role.the_patient_creation_validator_lambda_role.name
}
...
data "aws_iam_policy_document" "the_patient_creation_validator_lambda_execution_policy_document" {
  statement {
    effect = "Allow"
...
data "archive_file" "the_patient_creation_validator_lambda_zip" {
  output_path = local.patient_creation_validator_lambda_function_output_path
  type        = "zip"
