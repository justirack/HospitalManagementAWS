...
def lambda_handler(event: dict, context: dict) -> dict:
    ...
    The lambda will delete a patient from the DynamoDB database.
    """
    ...
    if response['ResponseMetadata']['HTTPStatusCode'] == 200:
        __logger.info(f'The patients information was successfully deleted from the table.')
        return format_return_message(200, patient_id)
